...
#define PIN_NUM_CS   05

#define PIN_NUM_DC   25
#define PIN_NUM_RST  0
#define PIN_NUM_BCKL 2

#define LCD_SEL_CMD()   gpio_set_output_level(PIN_NUM_DC,0) // Low to send command 
#define LCD_SEL_DATA()  gpio_set_output_level(PIN_NUM_DC,1) // High to send data
#define LCD_RST_SET()   gpio_set_output_level(PIN_NUM_RST,1) 
#define LCD_RST_CLR()   gpio_set_output_level(PIN_NUM_RST,0)
#define LCD_BKG_ON()    gpio_set_output_level(PIN_NUM_BCKL,1) // Backlight ON
#define LCD_BKG_OFF()   gpio_set_output_level(PIN_NUM_BCKL,0) //Backlight OFF
...
{
	PIN_FUNC_SELECT(PERIPHS_IO_MUX_GPIO25_U,2);   //DC PIN
	PIN_FUNC_SELECT(PERIPHS_IO_MUX_GPIO0_U,2);
	PIN_FUNC_SELECT(PERIPHS_IO_MUX_GPIO2_U,2);   //BKL PIN
	WRITE_PERI_REG(GPIO_ENABLE_W1TS_REG, BIT25|BIT0|BIT2);
}
...
static void spi_master_init()
{
	...
	WRITE_PERI_REG(GPIO_ENABLE_W1TS_REG, BIT5|BIT18|BIT23);
